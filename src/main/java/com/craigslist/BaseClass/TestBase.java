package com.craigslist.BaseClass;
...
import com.craigslist.Listener.WebEventListener;
	...
	public TestBase() {
		...
		try {
			...
			FileInputStream inputStream = new FileInputStream(
					System.getProperty("user.dir") + "/src/main/java/com/craigslist/Config/Configuration.properties");
